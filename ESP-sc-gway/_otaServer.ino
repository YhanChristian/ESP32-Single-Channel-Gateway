...
// We'll don't use these functions, because OTA didn't works with ESP32 yet.
// I left this file, because in the future we can use OTA with ESP32, and make few changes.
