...
#include "ESP-sc-gway.h" // This file contains configuration of gateway
#include <Esp.h>
#include <string.h>
#include <stdio.h>
#include <sys/types.h>
...
static void printTime() {
  switch (weekday()) {
    case 1: Serial.print(F("Domingo")); break; //Sunday
    case 2: Serial.print(F("Segunda")); break; // Monday
    case 3: Serial.print(F("Terça")); break; // Tuesday
    case 4: Serial.print(F("Quarta")); break; // Wednesday
    case 5: Serial.print(F("Quinta")); break; // Thursday
    case 6: Serial.print(F("Sexta")); break; // Friday
    case 7: Serial.print(F("Sábado")); break; // Saturday
