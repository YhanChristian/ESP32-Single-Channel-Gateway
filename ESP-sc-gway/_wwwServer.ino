...
// ----------------------------------------------------------------------------
// SET ESP32 WEB SERVER VARIABLES
//
...
static void openWebPage() {
  ...
  response += "<META NAME='AUTHOR' CONTENT='Yhan Christian (yhan.christian@live.com)'>";
  ...
  response += "<h1>ESP32 Gateway Config</h1>";

  response += "Version: "; response += VERSION;
  response += "<br>ESP32 alive since "; 					// STARTED ON
